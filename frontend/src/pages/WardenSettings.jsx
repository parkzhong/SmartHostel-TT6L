...
export default function WardenSettings() {
    ...
    const [jurisdiction, setJurisdiction] = useState("All Blocks");
        ...
        const load = async (currentUser) => {
            ...
            const loadProfileData = async () => {
                ...
                if (snap.exists()) {
                    ...
                    setRole(data.role ? data.role.charAt(0).toUpperCase() + data.role.slice(1) : "Warden");
                    setJurisdiction(data.jurisdiction || "All Blocks");
                }
            };
            loadProfileData();
        };
            ...
            <div className="warden-settings-container">
                ...
                <div className="warden-dashboard-header">
                    ...
                    <div className="header-actions">
                        <NotificationBell />
                        <button className="header-btn" onClick={() => navigate("/warden-settings")} style={{ background: '#f9fafb', borderColor: '#d1d5db', color: '#111827' }}>
                ...
                <div className="warden-settings-content">
                    ...
                    <div className="warden-sidebar">
                        <div className="warden-profile">
                            ...
                            <h2 className="warden-name">{fullName || "Chief Warden"}</h2>
                        ...
                        <div className="warden-stats">
                            <div className="stat-row">
                                ...
                                <span className="stat-value">{jurisdiction}</span>
                            </div>
                        </div>
                    ...
                    <div className="settings-main-wrapper">
                        <h1 style={{ fontSize: "24px", fontWeight: "700", marginBottom: "8px" }}>Warden Settings</h1>
                        <p style={{ color: "#6b7280", marginBottom: "24px" }}>Manage your warden account preferences.</p>
